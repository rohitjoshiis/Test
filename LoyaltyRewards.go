...
func (t *LoyaltyRewards) Init(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
...
func (t *LoyaltyRewards) Invoke(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
...
func (t *LoyaltyRewards)  RegisterPolicy(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
...
func (t *LoyaltyRewards) Query(stub shim.ChaincodeStubInterface,function string, args []string) ([]byte, error) {
...
func (t *LoyaltyRewards)  GetPolicyDetails(stub shim.ChaincodeStubInterface, PolicyId string) ([]byte, error) {
...
func main() {
	err := shim.Start(new(LoyaltyRewards))
	if err != nil {
